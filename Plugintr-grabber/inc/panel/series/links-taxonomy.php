            ...
            if(!empty($a[0])) {
                ...
                if( isset( $url['host'] ) ) {
                    ...
                    if ($term_server !== 0 && $term_server !== null) {
                        ...
                        //Torrent
                        if (strpos($_POST['trgrabber_link'][$i], 'magnet') !== false) {
                            $term_server = term_exists('Torrent', 'server');

                            if ($term_server !== 0 && $term_server !== null) {
                                $server_id[$i] = $term_server['term_id'];
                            } else {
                                $insert_server = wp_insert_term('Torrent', 'server', array());
                                $server_id[$i] = $insert_server['term_id'];
                            }
                        } else {
                            $server_id[$i] = '';
        ...
        if( $link !='' or $links_total == 0 ) :
            echo'
                    <tr class="tr-grabber-row">
                        ...
                        <td>
                            <input name="trgrabber_link[]" value="[seoprov10 src=&#34;&#34;]'.$linkk.'" type="text">
                        </td>
                        <td class="tdoptns">
                            <span class="edlnkbtn">
